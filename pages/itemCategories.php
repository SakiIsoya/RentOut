    ...
    <body>
            ...
            <div class="booking_table d_flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
                        <h2>Complete <?php echo $get_category['category_name']; ?></h2>
                        <h4>Camping Packages Rental</h4>
        ...
        <section class="facilities_area section_gap">
            ...
            <div class="container">
                ...
                <div class="row mb_30">
                    <?php
                        $get_items = $item->getItemsByCategory($category_id);
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="facilities_item">
                            <h4 class="sec_h4"><?php echo $row['item_name']; ?></h4>
                            <p></p>
                            <a href="single-item.php?item_id=<?php echo $row['item_id']; ?>"><div class="genric-btn primary">More</div></a>
                        </div>
                    </div>
                    <?php
                        }
